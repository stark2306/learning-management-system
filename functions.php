<?php
     ...
     * @return void
     */
    function process_registration_data($name,$email,$contact,$username,$password, $activation_key){
...
*/
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        {
            if($_POST['name'] && $_POST['email'] && $_POST['contact'] && $_POST['username'] && $_POST['original_password'] && $_POST['confirm_password'])
            {
                ...
                if($password1 == $password2)
                {
                    ...
                    process_registration_data($name,$email,$contact,$username,$password1,$activation_key);
                }
                else
                {

...
<head>
    ...
    <script src="/includes/js/bootstrap.bundle.min.js"></script> <!-- include bootstrap -->
    <script src="/includes/js/jquery-3.6.2.min.js"></script> <!-- include jquery -->
    ...
    <header class="shadow  bg-grey">
        <div class="container">
            ...
            <nav class="navbar pt-4 pb-3 navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="#"><img src="Images/dento-logo.png" alt=""></a>
